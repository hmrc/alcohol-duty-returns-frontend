...
declareAlcoholDutyQuestion.p1.l4 = 22.1% neu’n uwch
...
howMuchDoYouNeedToDeclare.checkYourAnswersLabel.row.head.DraughtRelief = Cyfradd is
...
adjustmentDutyDue.bulletList.1 = gwnaethoch ddatgan {0} litr o alcohol pur (LPA)
