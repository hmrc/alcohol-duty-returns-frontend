...
adjustmentReturnPeriod.default.title = Pryd gwnaethoch chi dalu toll ar hyn?
adjustmentReturnPeriod.default.heading = Pryd gwnaethoch chi dalu toll ar hyn?
adjustmentReturnPeriod.under-declaration.title = Pryd dylech chi fod wedi talu toll?
adjustmentReturnPeriod.under-declaration.heading = Pryd dylech chi fod wedi talu toll?
adjustmentReturnPeriod.exciseEnquiries.link = Ffoniwch CThEF neu cysylltwch â CThEF drwy’r post (yn agor tab newydd)
adjustmentReturnPeriod.paragraph = os cyhoeddwyd hyn yn wreiddiol cyn mis Awst 2023.
adjustmentReturnPeriod.hint = Er enghraifft, 10 2024
adjustmentReturnPeriod.date.error.required.all = Nodwch y dyddiad y gwnaethoch dalu toll
adjustmentReturnPeriod.date.error.required.month = Mae’n rhaid i’r dyddiad y gwnaethoch dalu toll gynnwys mis
adjustmentReturnPeriod.date.error.required.year = Mae’n rhaid i’r dyddiad y gwnaethoch dalu toll gynnwys blwyddyn
adjustmentReturnPeriod.date.error.invalid.future = Mae’n rhaid i’r dyddiad y gwnaethoch dalu toll fod yn y gorffennol
adjustmentReturnPeriod.date.error.invalid.month = Mae’n rhaid i’r dyddiad y gwnaethoch dalu toll fod yn ddyddiad go iawn gan ddefnyddio rhifau
adjustmentReturnPeriod.date.error.invalid.year = Mae’n rhaid i’r dyddiad y gwnaethoch dalu toll fod yn ddyddiad go iawn gan ddefnyddio rhifau
adjustmentReturnPeriod.date.error.invalid.past = Mae’n rhaid i’r dyddiad y gwnaethoch dalu toll fod ar ôl mis Gorffennaf 2023
