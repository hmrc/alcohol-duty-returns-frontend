...
case class AdjustmentDutyDueViewModel(dutyToShow: BigDecimal)

class AdjustmentDutyDueViewModelFactory {
  def apply(adjustmentType: AdjustmentType, duty: BigDecimal, newDuty: BigDecimal): AdjustmentDutyDueViewModel =
