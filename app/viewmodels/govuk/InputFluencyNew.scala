...
object inputNew extends InputFluencyNew

trait InputFluencyNew {

  object InputViewModelNew extends ErrorMessageAwareness {
...
//  implicit class FluentInputNew(input: Input) {
//
//    def asEmail(): Input =
//      input
//        .withInputType("email")
