...
echo "$className;format="decap"$.heading = $title$" >> ../conf/messages.en$pre_componentsubheadings$
echo "$className;format="decap"$.checkYourAnswersLabel = $className$" >> ../conf/messages.en$pre_componentmessages$
