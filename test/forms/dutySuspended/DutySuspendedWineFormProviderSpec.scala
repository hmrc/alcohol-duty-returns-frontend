...
class DutySuspendedWineFormProviderSpec extends BigDecimalFieldBehaviours {
  ...
  ".pureAlcoholInWine" - {
    ...
    behave like bigDecimalFieldWithMinimum(
      ...
      minimum = minimum,
      decimal = decimal,
      expectedError = FormError(fieldName, "dutySuspendedWine.error.pureAlcoholInWine.minimumRequired", ArraySeq(minimum))
    )
    ...
    behave like bigDecimalFieldWithMaximum(
      ...
      maximum = maximum,
      decimal = decimal,
      expectedError = FormError(fieldName, "dutySuspendedWine.error.pureAlcoholInWine.maximumRequired", ArraySeq(maximum))
    )
