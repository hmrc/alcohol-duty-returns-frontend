...
class ReturnTaskListSpec extends SpecBase {
  ...
  "returnTaskList" - {
    "on calling returnSection" - {
      "when the user answers object is empty, must return the not started section" in {
        val result = returnTaskListCreator.returnSection(emptyUserAnswers).toOption.get
      ...
      "when the user answers no to DeclareAlcoholDuty question, must return a complete section" in {
        val userAnswers = emptyUserAnswers
          ...
          .success
          .value
        val result      = returnTaskListCreator.returnSection(userAnswers).toOption.get
      ...
      "when the user answers yes to DeclareAlcoholDuty question, must return a complete section and the Product List task" - {
        ...
        "must have a link to ProductEntryGuidanceController if the user has not answer any other question" in {
          val result = returnTaskListCreator.returnSection(declaredAlcoholDutyUserAnswer).toOption.get
    ...
    "on calling returnDSDSection" - {
      ...
      "when the user answers object is empty, must return a not started section" in {
        val result = returnTaskListCreator.returnDSDSection(emptyUserAnswers).toOption.get
      ...
      "when the user answers no to Declare DSD question, must return a complete section" in {
        val userAnswers = emptyUserAnswers
          ...
          .success
          .value
        val result      = returnTaskListCreator.returnDSDSection(userAnswers).toOption.get
      ...
      "when the user answers yes to Declare DSD question, must return a complete section and the DSD task" - {
        ...
        "must have a link to DeclareDutySuspendedDeliveriesQuestionController if the user has not answered any other question" in {
          val result =
            returnTaskListCreator.returnDSDSection(declaredDSDUserAnswers(userAnswersWithAllRegimes)).toOption.get
        ...
        "must have a link to DeclareDutySuspendedDeliveriesQuestionController if the user answers yes to DSD question and not all regime questions are answered" in {
          ...
          val result = returnTaskListCreator.returnDSDSection(incompleteDutySuspendedDeliveriesUserAnswers).toOption.get
        ...
        "must have a link to CYA DSD controller if the user answers yes to the Declare DSD question and all regime questions are answered" in {
          ...
          val result = returnTaskListCreator.returnDSDSection(completeDutySuspendedDeliveriesUserAnswers).toOption.get
        ...
        "must have a link to CYA DSD controller if the user answers yes to the Declare DSD question and all regime questions except Cider, Wine and OtherFermentedProducts (as Cider, Wine and OtherFermented products are not included) are answered" in {
          val completeDutySuspendedDeliveriesUserAnswers =
            ...
            ).foldLeft(declaredDSDUserAnswers(userAnswersWithoutOtherFermentedProduct)) {
    ...
    "on calling returnQSSection" - {
      ...
      "when the user answers object is empty, must return a not started section" in {
        val result = returnTaskListCreator.returnQSSection(emptyUserAnswers).toOption.get
      ...
      "when the user answers no to Declare QS question, must return a complete section" in {
        val userAnswers = emptyUserAnswers
          ...
          .success
          .value
        val result      = returnTaskListCreator.returnQSSection(userAnswers).toOption.get
