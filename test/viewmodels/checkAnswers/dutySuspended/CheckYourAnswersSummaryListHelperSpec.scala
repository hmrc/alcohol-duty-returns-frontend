...
class CheckYourAnswersSummaryListHelperSpec extends SpecBase {
  ...
  "CheckYourAnswersSummaryListHelper" - {
    ...
    "must return a summary list with the correct rows" in {
      val summaryList = helper.dutySuspendedDeliveriesSummaryList(completedUserAnswers)
      ...
      val expectedActions = Seq(
        ActionItem(
          content = Text("Change"),
          href = controllers.dutySuspended.routes.DutySuspendedBeerController.onPageLoad(CheckMode).url,
        ...
        ActionItem(
          content = Text("Change"),
          href = controllers.dutySuspended.routes.DutySuspendedCiderController.onPageLoad(CheckMode).url,
        ...
        ActionItem(
          content = Text("Change"),
          href = controllers.dutySuspended.routes.DutySuspendedWineController.onPageLoad(CheckMode).url,
        ...
        ActionItem(
          content = Text("Change"),
          href = controllers.dutySuspended.routes.DutySuspendedSpiritsController.onPageLoad(CheckMode).url,
        ...
        ActionItem(
          content = Text("Change"),
          href = controllers.dutySuspended.routes.DutySuspendedOtherFermentedController.onPageLoad(CheckMode).url,
    ...
    "must return a summary list with only rows for approved regimes" in {
      ...
      val summaryList = helper.dutySuspendedDeliveriesSummaryList(completedUserAnswersOnlyBeer)
      ...
      val expectedValues = Seq("5.00 litres", "1.0000 litres")
