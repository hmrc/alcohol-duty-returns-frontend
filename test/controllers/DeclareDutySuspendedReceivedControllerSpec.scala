...
class DeclareDutySuspendedReceivedControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val declareDutySuspendedReceivedRoute = routes.DeclareDutySuspendedReceivedController.onPageLoad(NormalMode).url
  ...
  "DeclareDutySuspendedReceived Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(DeclareDutySuspendedReceivedPage, validAnswer).success.value
