...
class DeclareIrishWhiskyControllerSpec extends SpecBase with MockitoSugar {
  ...
  lazy val declareIrishWhiskyRoute = routes.DeclareIrishWhiskyController.onPageLoad(NormalMode).url
  ...
  "DeclareIrishWhisky Controller" - {
    ...
    "must populate the view correctly on a GET when the question has previously been answered" in {
      ...
      val userAnswers = UserAnswers(userAnswersId).set(DeclareIrishWhiskyPage, validAnswer).success.value
